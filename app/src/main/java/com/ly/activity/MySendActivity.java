...
public class MySendActivity extends BaseActivity {
    ...
    private void setListen() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MySendActivity.this, StoryDetailActivity.class);
    ...
    private void initView() {
        toolbar = (Toolbar) findViewById(R.id.activity_my_send_toolbar);
        setSupportActionBar(toolbar);
        listView = (ListView) findViewById(R.id.my_send_listView);
        iv_back = (ImageView) findViewById(R.id.activity_my_send_img_back);
    }
    ...
    private void initData() {
        ...
        httpUtils.send(HttpRequest.HttpMethod.GET, Constants.MYSEND_PATH, requestParams,
